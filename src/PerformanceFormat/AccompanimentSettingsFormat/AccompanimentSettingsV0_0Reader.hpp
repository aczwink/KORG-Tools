...
public:
	//Constructor
	inline AccompanimentSettingsV0_0Reader(libKORG::Performance::AccompanimentSettings& accompanimentSettings, libKORG::ChunkVersion& max9version)
...
private:
	//Members
	libKORG::Performance::AccompanimentSettings& accompanimentSettings;
