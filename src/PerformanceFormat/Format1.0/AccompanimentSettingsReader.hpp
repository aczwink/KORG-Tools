...
template<typename AccType, typename ReaderType, uint16 Version>
class AccompanimentSettingsReader : public libKORG::ChunkReader
{
public:
	//Constructor
	inline AccompanimentSettingsReader(AccType& accompanimentSettings)
			: versionReader(accompanimentSettings)
	{
	}
