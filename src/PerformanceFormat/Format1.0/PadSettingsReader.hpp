...
public:
	//Constructor
	inline PadSettingsReader(StdXX::StaticArray<libKORG::Performance::V1::PadSettings, 4>& padSettings) : padSettings(padSettings)
	{
	}
...
private:
	//Members
	StdXX::StaticArray<libKORG::Performance::V1::PadSettings, 4>& padSettings;
};