...
public:
	//Constructor
	inline TrackPropertiesReader(StdXX::StaticArray<libKORG::Performance::TrackProperties, N>& trackProperties) : trackProperties(trackProperties)
	{
	}
...
private:
	//Members
	StdXX::StaticArray<libKORG::Performance::TrackProperties, N>& trackProperties;

	//Methods
	int32 ReadVersion00Chunk(StdXX::DataReader& dataReader);
