...
void UnknownAdditionalReader::ReadDataChunk(const libKORG::ChunkHeader &chunkHeader, StdXX::DataReader &dataReader)
{
	switch(chunkHeader.id)
	{
		case 0x1B000008:
		{
			auto& chunk = this->generalPerformanceData._0x1B000008_chunk;
		...
		case 0x1A000008:
		{
			auto& chunk = this->generalPerformanceData._0x1A000008_chunk;
		...
		case 0x21000008:
		{
			auto& chunk = this->generalPerformanceData._0x21000008_chunk;
