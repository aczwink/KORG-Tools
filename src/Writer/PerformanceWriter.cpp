...
//Public methods
void PerformanceWriter::Write(const SingleTouchSettings &settings)
{
...
//Private methods
void PerformanceWriter::Write0x2000000Chunk(const libKORG::AccompanimentSettings& settings, const ChunkVersion& performanceVersion)
{
...
void PerformanceWriter::Write0x3000000Chunk(const KeyboardSettings &keyboardSettings, uint8 number, const ChunkVersion& performanceVersion)
{
...
void PerformanceWriter::WriteTrackProperties(uint32 trackNumber, const TrackProperties &trackProperties, const libKORG::ChunkVersion& performanceVersion)
{
