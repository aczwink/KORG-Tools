...
TEST_SUITE(GrandRXDemoWithRXNoises)
{
	TEST_CASE(Test)
	{
		const uint8 general_midi_percussionChannelZeroBased = 10 - 1;

		FileSystem::Path setPath(u8"testdata/styles/pa700oriental/grand_rx_demo_with_rxnoises.SET");
		Set set(setPath);
		...
		FileInputStream fileInputStream(String(u8"testdata/styles/pa700oriental/grand_rx_demo_with_rxnoises.SET/V1-CV1.MID"));
