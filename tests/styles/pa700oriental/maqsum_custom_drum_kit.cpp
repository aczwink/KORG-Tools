...
TEST_SUITE(MaqsumWithCustomDrumKit)
{
	TEST_CASE(Test)
	{
		const uint8 general_midi_percussionChannelZeroBased = 10 - 1;

		FileSystem::Path setPath(u8"testdata/styles/pa700oriental/maqsum_custom_drum_kit.SET");
		Set set(setPath);
		...
		FileInputStream fileInputStream(String(u8"testdata/styles/pa700oriental/maqsum_custom_drum_kit.SET/V1-CV1.MID"));
