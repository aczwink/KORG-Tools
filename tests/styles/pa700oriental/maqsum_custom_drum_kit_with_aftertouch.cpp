...
TEST_SUITE(MaqsumWithCustomDrumKitAndAfterTouch)
{
	TEST_CASE(Test)
	{
		const uint8 general_midi_percussionChannelZeroBased = 10 - 1;

		FileSystem::Path setPath(u8"testdata/styles/pa700oriental/maqsum_custom_drum_kit_with_aftertouch.SET");
		Set set(setPath);
		...
		FileInputStream fileInputStream(String(u8"testdata/styles/pa700oriental/maqsum_custom_drum_kit_with_aftertouch.SET/V1-CV1.MID"));
