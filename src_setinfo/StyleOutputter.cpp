...
void StyleOutputter::Output(const FullStyle &fullStyle)
{
	...
	this->Output(fullStyle.STS());
}

//Private methods
void StyleOutputter::Output(const StaticArray<struct TrackProperties, 4> &keyboardTrackProperties)
{
...
void StyleOutputter::Output(const StdXX::StaticArray<struct TrackProperties, 8>& accompanimentTrackProperties)
{
...
void StyleOutputter::Output(const GeneralPerformanceSettings::_0x07000008_chunk &data)
{
...
void StyleOutputter::Output(const GeneralPerformanceSettings::_0x08000008_chunk &data)
{
...
void StyleOutputter::Output(const AccompanimentSettings &accompanimentSettings)
{
...
void StyleOutputter::Output(const KeyboardSettings &keyboardSettings)
{
...
void StyleOutputter::Output(const SingleTouchSettings &sts)
{
...
void StyleOutputter::Output(const TrackProperties &trackProperties)
{
